...
* `agents/extraction.py` — trust-boundary prompt + close-tag spoof neutralization + non-object/non-array LLM-response controlled failures (Phase 0 behavior unchanged; only additive hardening)
